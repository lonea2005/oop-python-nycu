...
class shopkeeper(NPC):
    def __init__(self):
        ...
        self.shop=[]
        self.shop.append(shop_item('人工心臟',500000,10,12,'死亡時可以使用人工心臟復活，手術需消耗50%財產'))
        self.shop.append(shop_item('道具欄位',100000,10,2.15,'增加離開賭桌後可保存的道具數量'))
        self.shop.append(shop_item('永久隨機皇后',400000,3,30,'開局時獲得隨機皇后道具'))
        self.shop.append(shop_item('永久額外血量',100000,4,20,'開局時獲得額外血量'))
        self.shop.append(shop_item('永久未知藍圖',100000,3,7,'開局時獲得未知藍圖道具'))
        self.shop.append(shop_item('解鎖琉璃皇后',444444444,1,1,'象徵希望的靈魂將在賭局中出現'))
        self.shop.append(shop_item('解鎖惡魔試煉',9999999999,1,1,'通往地獄的大門為你敞開'))
    ...
    def before_challenge(self):
        print('利維坦: 小夥子要挑戰我? 希望你已經做好赴死的心理準備了，我可不會手下留情喔')
        time.sleep(2)
        print('利維坦: 順帶一提，如果你還沒從莉莉斯納裡聽說過的話，我可是我們三人之中最強的喔?')
        time.sleep(2)
        print('利維坦: 如果你能讓我欣賞你，我就來教你道具的真正使用方式 ')
        time.sleep(2)
        print('利維坦: 準備好的話就去賭桌找我吧')
        time.sleep(2)
        main_player.challenge_NPC = '利維坦'
        input('按下Enter回到大廳')
    def challenge_mode_dialogue(self,win_count,computer):
        #每場結束時說的話
        if win_count == 5:
    ...
    def devil_transform(self):
        print('利維坦: 先別急著走，小夥子')
        time.sleep(3)
        print('利維坦: 剛剛那像笨蛋一樣的行為，該不會是為了討好我才做的吧?')
        time.sleep(3)
        print('利維坦: 夠瘋，夠傻，夠有膽量，我就好這口')
        time.sleep(3)
        print('利維坦: 有沒有興趣成為我的眷屬啊?')
        time.sleep(3)
        action = input('成為利維坦的眷屬? 1.是 2.否')
        if action == '1':
            print('利維坦: 爽快的選擇，小弟你從今以後就是我的人了')
            time.sleep(3)
            print('你和利維坦碰了拳頭，你感覺到前臂上蛇的印記開始活躍')
            time.sleep(3)
            print('扭曲印記昇華成為了★利維坦印記★')
            main_player.unlockable_item.remove('扭曲印記')
            main_player.unlockable_item.append('★纏繞之蛇印記★')
            time.sleep(3)
            print('你成為了利維坦的眷屬')
            if main_player.devil == '':
                main_player.devil = '利維坦'
            else:
                time.sleep(2)
                print('你將不再是',main_player.devil,'的眷屬')
                main_player.devil = '利維坦'
            time.sleep(3)
            lobby_NPC[0].unlock_achievement('瘋狂的傻子')
        else:
            print('利維坦: 切，真是無趣')
            time.sleep(3)
            print('利維坦: 以後死了沒人救你可別怪我啊')
            time.sleep(3)
...
class host(NPC):
    ...
    def before_challenge(self):
        print('薩邁爾: 你要挑戰我? 你的勇氣令人敬佩')
        time.sleep(2)
        print('薩邁爾: 我和其他兩位不同，不喜歡花俏的道具或規則')
        time.sleep(2)
        print('薩邁爾: 這場試煉，請以你自己雙眼看破未來')
        time.sleep(2)
        print('薩邁爾: 如果你能擊敗我，我會賜予你我的羽翼')
        time.sleep(2)
        print('薩邁爾: 談話就此打住，準備好的話就去賭桌找我吧')
        time.sleep(2)
        input('按下Enter回到大廳')
        main_player.challenge_NPC = '薩邁爾'
    ...
    def challenge_mode_reward(self,player_lobby):
        if '墮天使印記' not in player_lobby.unlockable_item:
            ...
            time.sleep(2)
            lobby_NPC[0].unlock_achievement('墮落的羽翼')

    def devil_transform(self):
        print('薩邁爾: 這位客官，請留步')
        time.sleep(2)
        print('薩邁爾: 你的靈魂，你的堅持，我很欣賞')
        time.sleep(4)
        print('薩邁爾: 如果你想要，我可以讓你成為我的眷屬')
        time.sleep(4)
        print('薩邁爾: 別看我這樣，我也曾經是一名天使')
        time.sleep(4)
        print('薩邁爾: 我能給予你渴求的力量，相對的，你也將永遠為我效力')
        time.sleep(3)
        action = input('成為薩邁爾的眷屬? 1.是 2.否')
        if action == '1':
            print('薩邁爾: 了解，從現在起，你便不再是一個人類')
            time.sleep(4)
            print('薩邁爾把手搭在你的肩上，你感覺到一股強大的力量湧入你的身體')
            time.sleep(4)
            print('墮天使印記昇華成為了★死之天使印記★')
            main_player.unlockable_item.remove('墮天使印記')
            main_player.unlockable_item.append('★死之天使印記★')
            time.sleep(4)
            print('你成為了薩邁爾的眷屬')
            if main_player.devil == '':
    ...
    def tutorial(self):
        input('按下Enter推進對話')
        win_count = 0
        input('你走進了吵雜的賭場，一名男子憑空出現在你面前')
        input('薩邁爾: 你好，我是這裡的負責人，歡迎光臨BuckShot')
        
        input('薩邁爾: 需要我為你介紹一下嗎?')
        action = input('觀看教學? 1.是 2.否')
        if action == '2':
            input('薩邁爾: 原來是熟客了呀，真是失禮了')
            
            input('薩邁爾: 如果有任何問題，隨時可以來大廳找我，祝你賭運昌隆')
            
            return
        elif action == '1':
            input('薩邁爾: 了解了，那麼請跟我來')
            
            input('薩邁爾: BuckShot是一間由惡魔經營的賭場，我們提供巨額獎金，而你則是用靈魂作為賭注')
            
            input('薩邁爾帶著你到賭桌前，並交給你一把散彈槍')
            
            input('薩邁爾: 每局開始時，這把槍會以隨機順序裝填2~8發實彈或空包彈')
            
            input('薩邁爾: 輪到你的回合時，你可以選擇開槍射向自己或射向莊家')
            
            input('薩邁爾: 被實彈射中者將會損失1點血量')
            
            input('薩邁爾: 當你用空包彈射中自己時，你將獲得一個額外的回合')
            
            input('薩邁爾: 雙方輪流開槍直到子彈打空，進入下一局並重新裝填子彈')
            
            input('薩邁爾: 先將對方血量歸零者獲勝')
            
            input('薩邁爾: 以上便是惡魔輪盤的基礎規則，準備好的話就來練習一場吧?')
            ...
            while True:
                ...
                if player1.hp <= 0:
                    input('你忽然回過神來，發現自己仍坐在賭桌前，彷彿剛才都只是一場夢')
                    time.sleep(3)
                    input('薩邁爾: 賭博這種事，運氣是很重要的。希望你已經掌握基本規則了')
                    break
                elif computer1.hp <= 0:
                    win_count += 1
                    input('薩邁爾: 很好，看來你已經掌握了基本規則')
                    break
            
            input('薩邁爾: 那麼，接下來由利維坦為你介紹關於"道具"的規則吧')
            
            input('語畢，一名身材高挑，全身刺青的女子不知從何處出現，湊到你的面前')
            
            input('利維坦: 新來的小夥子挺標緻嘛，我是這裡的商店老闆，利維坦')
            
            input('利維坦: 你不覺得純粹賭運氣的遊戲有點無聊嗎?')
            
            input('利維坦: 然而只要加入道具，賭局就會變得更刺激，你說是吧?')
            
            input('薩邁爾在一旁瞪了她一眼，利維坦清了清喉嚨，繼續說道')
            
            input('利維坦: 接下來我會為你介紹一下道具的使用方法和規則')
            
            input('利維坦: 每局開始，也就是重新裝彈的時候，你和莊家都將隨機獲得2~5個道具')
            
            input('利維坦: 這些道具可以幫助你或者干擾對手，增加遊戲的變數性')
            
            input('利維坦: 你可以在每回合開槍前使用道具，想用幾個道具都可以，次數沒有限制')
            
            input('利維坦: 沒用完的道具將會保留，不過請注意每人最多持有8個道具')
            
            input('利維坦: 每個道具的效果各不相同，一般道具總共有9種，它們的效果分別是...什麼來著?')
            
            input('你聽到身後傳來一聲嘆氣，接著一本圖鑑被放到了賭桌上')
            
            input('莉莉斯: 這裡有一般道具的介紹，記下來對你會很有幫助')
            ...
            input('莉莉斯: 這些道具是普通道具，當然未來你在賭桌上有機會遇見一些特殊道具')
            
            input('莉莉斯: 到時候你可以來我這裡查看圖鑑，我會告訴你如何使用這些道具')
            
            input('利維坦: 咳咳...總之，準備好的話就來練習一場吧? 嘿嘿嘿，我會讓你體驗道具真正的力量......')
            
            input('薩邁爾一拳打在利維坦頭上，強行把她拖走')
            
            input('莉莉斯: 那個笨蛋總是會搞出不必要的混亂。這場就由我來幫你練習吧?')
            ...
            while True:
                ...
                if player1.hp <= 0:
                    input('你忽然回過神來，發現自己正趴在賭桌前，莉莉斯剛好為你完成包紮')
                    break
                elif computer1.hp <= 0:
                    win_count += 1
                    input('莉莉斯: 你學得很快呢! 靈活運用道具是致勝的關鍵')
                    break
            
            input('莉莉斯: 那麼以上就是關於道具的使用方法和基本規則')
            
            input('莉莉斯: 如果有任何規則相關的問題，你可以在大廳找到薩邁爾，他會很樂意為你解答')
            
            input('莉莉斯: 遇到新的道具或者想要一些關於賭局的技巧，都可以來找我')
            
            input('莉莉斯: 順帶一提，利維坦那笨蛋負責商店，等你有錢後也可以去她那裡光顧一下')
            
            input('莉莉斯: 然後這個給你，在你犯錯時可以救你一命，就當作是初次見面的禮物吧')
            
            input('你獲得了人工心臟，可以在死亡的復活一次，使用時消耗50%財產作為手術費用')
            main_player.unlockable_item.append('人工心臟')
            
            input('莉莉斯: 那麼祝你好運，希望你能在這裡找到你想要的東西')
    ...
    def show_rule(self):
        ...
        if lobby_NPC[0].achievement_list[2].unlock == True:
            ...
            i += 1
        if main_player.enable_challenge == True:
            print(str(i)+'.挑戰惡魔試煉')
            rule_list.append('挑戰惡魔試煉')
            i += 1
        ...
        if action == 1:
            ...
            main_player.enable_challenge = True
            input('按下Enter回到上一頁')
...
class collection_manager(NPC):
    def __init__(self):
        ...
        self.mark_item.append(all_item('墮天使印記','剩下1點血量時，立即恢復3點血量，獲勝後重置使用次數'))
    ...
    def show_mark_item(self):
        print('惡魔印記:')
        #顯示物品名稱和敘述
        if '★慾之血印記★' not in main_player.unlockable_item:
            print(1,self.mark_item[0].name)
            print('    ',self.mark_item[0].description)
        elif '★慾之血印記★' in main_player.unlockable_item:
    ...
    def show_list(self):
        ...
        print('3.皇后&國王道具')
        print('4.惡魔印記')
        if '扭曲印記' in main_player.unlockable_item and not main_player.enable_challenge:
            print('5.扭曲印記啟用時的道具')
            print('6.成就列表')
        elif '扭曲印記' in main_player.unlockable_item:
            print('5.扭曲印記啟用時的道具')
            print('6.成就列表')
            print('7.挑戰惡魔試煉')
        elif main_player.enable_challenge:
            print('5.成就列表')
            print('6.挑戰惡魔試煉')
        else:
            print('5.成就列表')
        ...
        if choice == '1':
            ...
            self.show_list()
        elif choice == '5' and '扭曲印記' not in main_player.unlockable_item and not main_player.enable_challenge:
            self.show_achievement_1()
            self.show_achievement_2()
            self.show_list()
        elif choice == '6' and '扭曲印記' in main_player.unlockable_item:
            self.show_achievement_1()
            self.show_achievement_2()
            self.show_list()
        elif choice == '6' and '扭曲印記' not in main_player.unlockable_item and main_player.enable_challenge:
            self.before_challenge()
    ...
    def before_challenge(self):
        print('莉莉斯: 你要挑戰我嗎? 也不是不行，就來玩玩吧')
        time.sleep(2)
        print('莉莉斯: 久違的靈魂狩獵，就讓我嚐嚐你靈魂的滋味吧')
        time.sleep(2)
        print('莉莉斯: 如果你能贏過我，我就傳授你吸收他人靈魂的技巧!')
        time.sleep(2)
        if lobby_NPC[0].achievement_list[2].unlock:    
            print('莉莉斯: ......')
            time.sleep(2)
            print('莉莉斯: ...如果你能讓我滿意的話，想成為眷屬什麼的也不是不行啦......')
            time.sleep(2)
            print('莉莉斯: 總之，你準備好之後就到賭桌找我吧')
        else:
            print('莉莉斯: 那麼，你準備好之後就到賭桌找我吧')
        time.sleep(2)
        input('按下Enter回到大廳')
        main_player.challenge_NPC = "莉莉斯"
    ...
    def devil_transform(self):
        print('莉莉斯: ......吶')
        time.sleep(2)
        print('莉莉斯叫住了你，一隻手輕輕地拉著你的衣角，面色潮紅')
        time.sleep(4)
        print('莉莉斯: 你應該知道了吧? 我喜歡的類型......')
        time.sleep(4)
        print('莉莉斯: ...你想成為我的眷屬嗎?')
        time.sleep(4)
        print('莉莉斯: 我可以教你更多...技巧，如果你懂我的意思的話')
        time.sleep(4)
        print('語畢，莉莉斯的手指輕輕地滑過你的臉頰')
        time.sleep(4)
        print('莉莉斯: 那麼，你的回答是?')
        time.sleep(3)
        action = input('1.接受 2.拒絕 :')
        if action == '1':
            print('莉莉斯: ......色鬼')
            time.sleep(2)
            print('......')
            ...
            print('......一段時間後')
            time.sleep(2)
            print('莉莉斯: 呼...不愧是年輕人，真是有活力')
            time.sleep(4)
            print('經歷漫長的儀式之後，你成為了莉莉斯的眷屬')
            time.sleep(3)
            if main_player.devil == '':
                main_player.devil = '莉莉斯'
            else:
                time.sleep(2)
                print('你將不再是',main_player.devil,'的眷屬')
                main_player.devil = '莉莉斯'
                time.sleep(2)
            print('嗜血印記昇華成為了★慾之血印記★')
            main_player.unlockable_item.append('★慾之血印記★')
            main_player.unlockable_item.remove('嗜血印記')
            time.sleep(3)
            print('莉莉斯: 你的靈魂將永遠屬於我，不要忘記我們的約定喔')
            time.sleep(3)
            lobby_NPC[0].unlock_achievement('慾望的奴隸')
            time.sleep(2)
        else:
            print('莉莉斯: 這樣啊......')
            time.sleep(4)
            print('你感受到莉莉斯的失落，但她很快又掛起了微笑')
            time.sleep(4)
            print('莉莉斯: 如果以改變主意的話，仍然可以隨時回來找我，我會等你的')
            time.sleep(3)
...
class player(participant):
    ...
    def enable_mark(self,blood,snake,death,lust,warp,angel):
        ...
        self.have_snake_mark = snake or warp
        self.have_death_mark = death or angel
        self.have_angel_mark = angel
        self.have_warp_mark = warp
    ...
    def one_round_Leviathan(self,live_bullet,blank,item_number):
        ...
        while len(remain_bullet) > 0:
            ...
            if action==1:
                ...
                if player_item_used >= 8:
                    lobby_NPC[1].devil_dependency = True
                if remain_bullet[0]&handsaw&killer_queen:
                    self.player.hp -= 10
                    print('你用漆黑皇后射中了自己,造成十點傷害')
                    if self.player.blood_queen > 0:
...
class final_game(game):
    ...
    def give_item(self, number):
        ...
        for i in range(number):
            ...
            if len(self.computer.item) < self.computer.max_item:
                self.computer.item.append(choice(self.devil_princess_item_list))
        self.player.item.sort(key = ['琉璃皇后','漆黑皇后','神聖皇后','蔚藍皇后','腥紅皇后','未知藍圖','禁藥','大口徑子彈','榴彈砲','彈藥包','放大鏡','香菸','手鋸','啤酒','手銬','手機','轉換器','過期藥物','腎上腺素'].index)
        self.computer.item.sort(key = self.devil_princess_item_list.index)
    
    def give_participant_item(self, number, participant):
        return super().give_participant_item(number, participant)
    def set_first_move(self, first_move):
        return super().set_first_move(first_move)
    def blessing(self,remain_bullet,turn,handsaw):
        print('★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★')
        print('琉璃祝福治癒了你的傷口')
        self.player.hp += self.player.blessing
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if main_player.money >= 99999999999:
        ...
        if action == '1':
            ...
            if main_player.enable_challenge:
                print('8. 挑戰惡魔試煉')
                print(str(len(lobby_NPC[1].shop)+1) + ' 離開商店')
            else:
                print(str(len(lobby_NPC[1].shop)+1) + ' 離開商店')
            ...
            if action == '1':
                ...
                if main_player.money >= lobby_NPC[1].shop[6].price and lobby_NPC[1].shop[6].check_required_item(main_player):
                    ...
                    print('你的錢不夠或者連勝數不足')
            elif action == '8' and main_player.enable_challenge:
                lobby_NPC[1].before_challenge()
            time.sleep(1)
            continue
        elif action == '3':
            ...
            if '★慾之血印記★' in main_player.unlockable_item:
                lobby_NPC[0].unlock_mark_item('★慾之血印記★')
            if '★還沒想好★' in main_player.unlockable_item:
                lobby_NPC[0].unlock_mark_item('★還沒想好★')
            if '★死之天使印記★' in main_player.unlockable_item:
                lobby_NPC[0].unlock_mark_item('★死之天使印記★')
                ...
                if player1.money == 0:
                    ...
                    if action == '1':
                        ...
                        if (win_count >= 10) and ('十連勝標記' not in main_player.unlockable_item):
                            ...
                            print('你獲得了十連勝標記')
                        if (win_count >= 15) and ('十五連勝標記' not in main_player.unlockable_item):
                            main_player.unlockable_item.append('十五連勝標記')
                            print('你獲得了十五連勝標記')
                        ...
                        if (win_count >= 50) and ('五十連勝標記' not in main_player.unlockable_item):
                            ...
                            print('你獲得了五十連勝標記')
                            lobby_NPC[0].unlock_achievement('天文數字')
                        if (win_count >= 5):
                            print('你連勝了',win_count,'場')
                        input('按下Enter離開')
                        if win_count >= 10:
        ...
        if in_challenge_mode == True:
            if main_player.challenge_NPC == '莉莉斯':
                challenger = lobby_NPC[0]
            elif main_player.challenge_NPC == '利維坦':
                challenger = lobby_NPC[1]
            elif main_player.challenge_NPC == '薩邁爾':
                challenger = lobby_NPC[2]
            round = 1
            win_count = 0
            player1 = player(5,main_player.item,money)
            computer1 = computer(5,[])
            ...
            if challenger.name == '莉莉斯':
                ...
                #莊家先手+殺手國王
                risk = 21
                lobby_NPC[1].devil_dependency = False
        ...
        while in_challenge_mode == True:
            ...
            if player1.hp <= 0:
                ...
                if win_count < max_round:
                    ...
                    lobby_NPC[0].unlock_special_item()
                    time.sleep(2)
                    if lobby_NPC[0].devil_dependency and challenger.name == '莉莉斯':
                        lobby_NPC[0].devil_transform()
                    elif lobby_NPC[1].devil_dependency and challenger.name == '利維坦':
